...
MasterBot, as per spec sheet spec sheet
the system takes -p PortNo as commandline arguement 
can execute the following commands
1. connect SlaveIP/SlaveHostName TargetHostName/IP TargetPortNo No.OfConnections/default_1
2. disconnect SlaveIP/SlaveHostName/all TargetHostName/IP TargetPortNo/all
3. list
4. exit
